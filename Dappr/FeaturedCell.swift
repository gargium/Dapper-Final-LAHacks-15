...
@IBOutlet weak var outfitPicture: UIImageView!
    ...
    func setContents(name: String, desc: String, imgData: NSData, storeURL: String, imgURL: String, price: String) {
    ...
    func handlePan(recognizer: UIPanGestureRecognizer) {
        ...
        if recognizer.state == .Ended {
            ...
            if !deleteOnDragRelease {
                ...
                var favorite = PFObject(className: "Favorite")
                favorite["price"] = self.price
                favorite["imgURL"] = self.imgURL
                favorite["storeURL"] = self.storeURL
                favorite["name"] = name_label.text
                favorite["user"] = user
                favorite.save()
            }
            if deleteOnDragRelease {
