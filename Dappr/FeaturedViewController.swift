                ...
                if json != nil {
                    if let reposArray = json!["results"]["collection1"].array  {
                        for item in reposArray{
                            ...
                            var storeURL = item["img"]["href"].string
                            repositories.append(Repository(n: name!, d: price!, i: imagePath!, s: storeURL!))
                        }
...
//    
    ...
    func toDoItemDeleted(toDoItem: FeaturedCell) {
     ...
     func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        var stURL = repositories[indexPath.row].storeURL
        ...
        if cell != nil && data != nil {
            ...
            cell!.setContents(nameObj!, desc: "submitted by anonymous user", imgData: data!, storeURL: stURL!, imgURL : imgObj!, price: descObj!)
        }
